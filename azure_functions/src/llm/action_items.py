...
from src.llm.utils import LLMCallLogger
from src.llm.function_calling import make_function_call
...
def generate_action_items(
    ...
    logger: LLMCallLogger = None,  # type: ignore
) -> List[ActionItem]:
    """
    ...
    response_properties = make_function_call(
        model=model,
        messages=messages,
        functions=functions,
    ...
    new_action_items_text: List[str] = response_properties["action_items"]  # type: ignore
    ...
    return new_action_items, llm_call  # type: ignore
